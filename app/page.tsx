...
export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-100 via-purple-200 to-purple-300 text-gray-800">
      {/* Header */}
      ...
      {/* Success Rate */}
      <section className="bg-purple-100 py-24 text-center px-4">
